...
class cQube_CRC_Report(unittest.TestCase):
    ...
    def test_cluster_data(self):
        ...
        self.assertNotEqual(0, result, msg="Some files are not downloaded")
    ...
    def test_blockwise_tabledata(self):
    ...
    def peformance_of_crc_report(self):

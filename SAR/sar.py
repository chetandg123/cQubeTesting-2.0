...
class cQube_Student_Attendance(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.x = arg()
        # self.data.select_month_year(self.x.list[0], self.x.list[1])
    ...
    #     # schools = SchoolsPerClusterCsvDownload(self.driver,self.x.list[0],self.x.list[1])
    #     schools = SchoolsPerClusterCsvDownload(self.driver, '2019', 'October')

...
from School_infrastructure.Infra_map_Report.click_on_block_cluster_school_and_check_schoolscount import Block_cluster_school_count
...
class cQube_SI_Map_Report(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        time.sleep(2)
        self.data.select_management_to_infra_map_report(3)
